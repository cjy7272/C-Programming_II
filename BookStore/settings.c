...
void charge_money()
{
    ...
    while (1)
    {
        ...
        gotoxy(x, y);     printf("¦£¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¤");
        gotoxy(x, y + 1); printf("¦¢                                        ÀÜ¾× ÃæÀüÇÏ±â                                         ¦¢");
        gotoxy(x, y + 2); printf("¦§¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦©");
        gotoxy(x, y + 3); printf("¦¢                                                                                              ¦¢");
        gotoxy(x, y + 4); printf("¦¢   ÃæÀü ±Ý¾×À» ÀÔ·ÂÇÏ¼¼¿ä (1¸¸¿ø ´ÜÀ§ / ÃÖ¼Ò 1¸¸¿ø) (ÃÖ´ë 9,000,000¸¸¿ø)                      ¦¢");
        gotoxy(x, y + 5); printf("¦¢                                                                                              ¦¢");
        gotoxy(x, y + 6); printf("¦¢   ÀÔ·Â: ");
        printf("%7d¿ø                                                                            ¦¢", amount);
        gotoxy(x, y + 7); printf("¦¢                                                                                              ¦¢");
        gotoxy(x, y + 8); printf("¦§¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦©");
        gotoxy(x, y + 9); printf("¦¢   Enter: È®ÀÎ    ESC: Ãë¼Ò                                                                   ¦¢");
        ...
        else if (key == 13)       // Enter
        {
            ...
            {
                system("cls");
                printf("Àß¸øµÈ ±Ý¾×ÀÔ´Ï´Ù.\n1¸¸¿ø ´ÜÀ§, ÃÖ¼Ò 1¸¸¿ø ÀÌ»ó ÀÔ·ÂÇÏ¼¼¿ä.\n");
                system("pause");
            }
        }
        else if (key >= '0' && key <= '9')
